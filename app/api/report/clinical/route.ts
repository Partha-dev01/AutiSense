...
Note: This motor assessment is based on AI-assisted behavioral observation and should be supplemented with a formal motor development evaluation (e.g., Movement ABC-2 or BOT-2) by a qualified occupational therapist.`;
...
IMPORTANT DISCLAIMER: This report is generated by an AI-assisted screening tool and is NOT a clinical diagnosis. Autism spectrum disorder can only be diagnosed by qualified healthcare professionals through comprehensive evaluation. This screening is intended to support -- not replace -- clinical judgment.`;
...
export async function POST(req: NextRequest) {
  ...
  if (!client) {
    console.warn(
      "[Report/Clinical] AWS credentials not configured -- returning mock report",
    );
